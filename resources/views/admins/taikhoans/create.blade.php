        ...
        <div class="container">
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admins.taikhoans.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        @error('email') is-invalid @enderror"
                                            value="{{ old('email') }}" placeholder="Tên danh mục">
                                        @error('email')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        @error('password') is-invalid @enderror"
                                            value="{{ old('password') }}" placeholder="Tên danh mục">
                                        @error('password')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
